export const PLATFORM_ITEMS = [
  { key: 'claude-code', brand: 'claude', label: 'Claude Code', onClass: 'border-green-500/30 bg-green-500/15 text-green-600 dark:text-green-400', offClass: 'border-border bg-muted/40 text-muted-foreground' },
