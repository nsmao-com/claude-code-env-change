export const PLATFORM_ITEMS = [
  ...
  { key: 'gemini', brand: 'gemini', label: 'Gemini', onClass: 'border-blue-500/30 bg-blue-500/15 text-blue-600 dark:text-blue-400', offClass: 'border-border bg-muted/40 text-muted-foreground' },
